...
func (a *Api) createClusterHandler(params cluster.CreateClusterParams) middleware.Responder {
	...
	core := generateCore(c)
	resultCore, err := a.createCore(core, c.namespace)
	if err != nil {
...
func (a *Api) patchClusterHandler(params cluster.PatchClusterParams) middleware.Responder {
	...
	if !exist {
		...
		resultVanus, err := a.createCore(core, cons.DefaultNamespace)
		if err != nil {
		...
		resultVanus, err := a.patchCore(core)
		if err != nil {
...
func (a *Api) getClusterHandler(params cluster.GetClusterParams) middleware.Responder {
	core, err := a.getCore(cons.DefaultNamespace, cons.DefaultVanusClusterName, &metav1.GetOptions{})
	if err != nil {
