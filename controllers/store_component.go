...
func updateStore(sts *appsv1.StatefulSet, core *vanusv1alpha1.Core) {
	sts.Spec.Replicas = &core.Spec.Replicas.Store
	sts.Spec.Template.Spec.Containers[0].Image = fmt.Sprintf("%s:%s", cons.StoreImageName, core.Spec.Version)
}
