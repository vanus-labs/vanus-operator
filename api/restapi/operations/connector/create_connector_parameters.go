...
// CreateConnectorParams contains all the bound params for the create connector operation
...
//
// To ensure default values, the struct must have been initialized with NewCreateConnectorParams() beforehand.
func (o *CreateConnectorParams) BindRequest(r *http.Request, route *middleware.MatchedRoute) error {
	var res []error
