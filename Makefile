...
# linkall.com/vanus-operator-bundle:$VERSION and linkall.com/vanus-operator-catalog:$VERSION.
IMAGE_TAG_BASE ?= linkall.com/vanus-operator
...
IMG ?= public.ecr.aws/vanus/operator:latest
